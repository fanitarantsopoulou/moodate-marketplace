...
<template>
  <main class="flex-1 flex justify-center items-center p-6">
    <div class="bg-[#fdfcf0] border-8 border-double border-[#451a03] p-10 shadow-[16px_16px_0px_0px_rgba(69,26,3,1)] w-full max-w-2xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-2 grid grid-cols-3 gap-4 border-t-2 border-[#451a03]/20 pt-6">
            <div class="col-span-1">
              ...
              <input v-model="form.city" type="text" class="w-full bg-[#fef3c7] border-2 border-[#451a03] px-4 py-2 rounded-none outline-none font-bold shadow-[4px_4px_0px_0px_rgba(69,26,3,1)]" required>
            </div>
            <div>
              <label class="block text-[#451a03] font-black uppercase text-xs mb-1">State</label>
              <input v-model="form.state" type="text" class="w-full bg-[#fef3c7] border-2 border-[#451a03] px-4 py-2 rounded-none outline-none font-bold shadow-[4px_4px_0px_0px_rgba(69,26,3,1)]" required>
            </div>
            <div>
              <label class="block text-[#451a03] font-black uppercase text-xs mb-1">ZIP</label>
              <input v-model="form.zip" type="text" class="w-full bg-[#fef3c7] border-2 border-[#451a03] px-4 py-2 rounded-none outline-none font-bold shadow-[4px_4px_0px_0px_rgba(69,26,3,1)]" required>
            </div>
          </div>
        </div>

        <button type="submit" class="w-full mt-10 bg-[#d97706] text-[#fdfcf0] border-4 border-[#451a03] py-4 rounded-none font-black text-2xl uppercase italic tracking-tighter hover:bg-orange-600 transition shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">
          Sign the Contract
        </button>
      </form>
      ...
      <div class="mt-8 text-center">
        <p class="text-[#451a03] font-bold uppercase text-sm">
          Already one of us? 
          <router-link to="/login" class="text-[#963030] underline decoration-4 hover:text-red-700">Get to Login</router-link>
        </p>
      </div>
