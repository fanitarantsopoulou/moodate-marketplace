...
.btn-like { background: linear-gradient(135deg, #4CAF50, #8BC34A); color: white; box-shadow: 0 4px 15px rgba(76, 175, 80, 0.4); }
.btn-reset { background: white; color: #667eea; margin-top: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
.no-more { background: white; padding: 40px; border-radius: 20px; color: #333; box-shadow: 0 10px 30px rgba(0,0,0,0.2); }
.no-more h2 { font-size: 1.8rem; margin-bottom: 10px; }
.liked-list { margin-top: 20px; text-align: left; background: #f5f5f5; padding: 15px; border-radius: 10px; }
.liked-list h3 { margin-bottom: 10px; color: #4CAF50; }
.liked-item { padding: 8px 0; border-bottom: 1px solid #ddd; }
